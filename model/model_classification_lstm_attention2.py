...
- Adds a second layer of LSTM for improved temporal feature extraction (2-layered)
- Adds dropout of 0.3 to the LSTM layers for regularization between layers.
"""
...
class Model(BaseRGBModel):
    class Impl(nn.Module):
        def __init__(self, args = None):
            ...
            self._lstm = nn.LSTM(input_size=self._d, hidden_size=self._d, batch_first=True, num_layers=2, bidirectional=True, dropout=0.3)
